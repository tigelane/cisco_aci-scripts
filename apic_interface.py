...
################################################################################
'''
    Base methods for use by the "apic" scripts.
'''
...
def export_duplication():
	my_duplication_file = 'apic_duplicaiton.py'
	try:
		dup_file = open(my_duplication_file, 'w')
	except:
		print ('\n\nDuplication file can not be created: ' + my_duplication_file + '\n\n')
		exit()

	# config =
	dup_file.write(config)
	dup_file.close()
	print ('Duplication file created: ' + my_duplication_file + '\n\n')     
...
esxi_servers = dict(
	...
	config_file.close()
	print ('Configuration file created: ' + my_config_file + '\n\n')
